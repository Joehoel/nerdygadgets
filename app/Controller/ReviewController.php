...
class ReviewController
{
  ...
  public function create($id)
  {
    if (!isset($_SESSION['User']['UserID'])) {
      return header("Location: " . base_url . "product/" . $id . "?error= " . _("Je moet ingelogd zijn om een review te maken"));
    }

    if (isset($_POST['review-text']) && strlen($_POST['review-text']) > 1000) {
